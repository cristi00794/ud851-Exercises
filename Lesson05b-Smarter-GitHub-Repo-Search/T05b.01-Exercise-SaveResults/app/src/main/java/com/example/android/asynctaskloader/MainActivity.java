...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String queryURLKey = "QUERY_URL_KEY";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String searchJSONKey = "SEARCH_JSON_KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            if(savedInstanceState.containsKey(searchJSONKey)){
                mSearchResultsTextView.setText(savedInstanceState.getString(searchJSONKey));
            }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(queryURLKey,mUrlDisplayTextView.getText().toString());
        outState.putString(searchJSONKey,mSearchResultsTextView.getText().toString());
    }
